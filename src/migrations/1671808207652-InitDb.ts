...
export class InitDb1671808207652 implements MigrationInterface {
    name = 'InitDb1671808207652'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`horario\` (\`id\` varchar(36) NOT NULL, \`create_ad\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`update_ad\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`dias\` varchar(255) NOT NULL, \`monto\` int NOT NULL, \`categoria\` varchar(255) NOT NULL, \`hora\` varchar(255) NOT NULL, \`sede_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
